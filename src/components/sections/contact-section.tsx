...
export default function ContactPage() {
  ...
  return (
    <div  className="flex h-screen bg-[#666C73] text-white overflow-hidden">
      {/* Main Content */}
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-background/20 border border-[#EA3AB8]/30 text-white flex h-10 w-full px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-white/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#EA3AB8] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 rounded-md"
                    required
                  />
                </div>
                <div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full h-40 bg-background/20 border border-[#EA3AB8]/30 text-white flex min-h-[80px] w-full px-3 py-2 text-sm ring-offset-background placeholder:text-white/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#EA3AB8] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 rounded-md"
                    required
                  />
                </div>
